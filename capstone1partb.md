...
* **Project Title: Predicting MLB Home Run Season Totals**
* **Data Modality: Tabular** 
* **Task Type: Regression** 
* **One-Sentence Goal:** Predict the number of home runs the top players will hit in an upcoming MLB season based on their age, experience, recent performance, and historical playing time patterns.
